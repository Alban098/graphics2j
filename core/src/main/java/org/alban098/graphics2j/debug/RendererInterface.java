...
public abstract class RendererInterface extends DebugInterface {

  private Renderer selectedRenderer;

  public RendererInterface(String title) {
    super(title);
  }
  ...
  public void render() {
    ...
    Collection<Renderer> renderers = getRenderers();
  ...
  protected abstract Collection<Renderer> getRenderers();
}
