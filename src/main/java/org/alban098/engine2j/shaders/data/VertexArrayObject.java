 ...
 */
package org.alban098.engine2j.shaders.data;
...
import org.alban098.engine2j.objects.entities.component.TransformUtils;
import org.alban098.engine2j.shaders.ShaderAttribute;
import org.alban098.engine2j.shaders.ShaderAttributes;
import org.alban098.engine2j.shaders.data.vbo.FloatVertexBufferObject;
import org.alban098.engine2j.shaders.data.vbo.IntegerVertexBufferObject;
import org.alban098.engine2j.shaders.data.vbo.VertexBufferObject;
 ...
 * org.alban098.engine2j.shaders.ShaderProgram}. It will map each {@link ShaderAttribute} to a
...
public final class VertexArrayObject {
   ...
   * org.alban098.engine2j.shaders.ShaderProgram} via a {@link VertexBufferObject}
   */
